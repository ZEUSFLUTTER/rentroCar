        ...
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500'>
            <div className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor border-b'>
                ...
                <div>
                    ...
                    <p className='max-w-80 mt-3'>
                        Premium car rental service with a wide selection of luxury and everyday vehicules for all your driving needs
                    </p>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        <li>1234 DSJ Drive</li>
                        <li>5909 Elmwood Avenue Philadelphia, PA 19143</li>
                        <li>+1 (484) 848-4593 </li>
                        <li>dogblakleist04@gmail.com</li>
                    </ul>
                </div>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                ...
                <ul className='flex items-center gap-4'>
                    <a href="#">Privacy</a><li>|</li>
                    <a href="#">Terms</a><li>|</li>
                    <a href="#">Cookies</a><li></li>
                </ul>
            </div>
        </div>
    )
